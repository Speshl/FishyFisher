...
def main():
    ...
    print("Creating MP Pool of size ", cpuCount)
    ...
    while keepRunning :
        ...
        print("Screenshot took ",screenShotTime-startTime)
        highestConfidence = -1
        newState = ""
        ...
        results = [pool.apply(compareImages, args=(currentImage, key, value)) for key, value in templates.items()]
        for key, matchConfidence in results:
        ...
        print("Comparison took ",comparisonTime-screenShotTime)
...
def compareImages(image, key, template):
    confidenceValue = 0
...
bindings = [
    ...
    [["page_up"], None, moveCameraUp],
    [["page_down"], None, moveCameraDown],
]
